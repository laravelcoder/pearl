      ...
      <ul class="slides">
        ...
        <li>
          ...
          <div class="hero-text-wrap gradient-overlay-bg">
            <div class="hero-text">
              <div class="container text-center">
                <h2 class="white-color text-uppercase font-400 letter-spacing-5">Find Your Pearl</h2>
                <h1 class="white-color text-uppercase font-700">Select a Design</h1>
        ...
        <li>
          ...
          <div class="hero-text-wrap">
            <div class="hero-text">
              <div class="container text-center">
                <h2 class="white-color text-uppercase font-400 letter-spacing-5">PEARL</h2>
                <h1 class="white-color text-uppercase font-700">essence</h1>
                <h3 class="white-color font-400">Schedule your party today.</h3>
                {{-- <p class="text-center mt-30"><a class="btn btn-color btn-circle">See Our Parties</a> </p> --}}
              </div>
            </div>
          </div>
        </li>
